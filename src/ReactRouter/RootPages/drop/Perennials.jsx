...
const Perennials = () => {
    ...
    const filteredDatal1 = PopularAPI.filter(product => product.id >= 106 && product.id <= 110);
    const filteredDatal2 = PopularAPI.filter(product => product.id >= 111 && product.id <= 115);
    // const filteredDatal3 = annualAPI.filter(e => e.id >= 21 && e.id <= 30);
    return (
        <>
            <div className="ban" id="carou">
                <img src="/image/cercar2.jpg" className="Car" id="Image" alt="..." />
            </div>
            <div className="cerh"> <h4>Perennial Plants</h4></div>
            <div className="ce">
                {filteredDatal1.map(product => {
                    return (
                        <>
