...
const Annual= () => {
  ...
  const { handleAddToWishlist } = useWishlist();
    ...
    const filteredDatal1 = PopularAPI.filter(product => product.id >= 86 && product.id <= 90);
    const filteredDatal2 = PopularAPI.filter(product => product.id >= 91 && product.id <= 95);
    return (
        <>
            <div className="ban" id="carou">
            <img src="/image/cercar2.jpg" className="Car" id="Image" alt="..." />
            </div>
            <div className="cerh"> <h4>Annual Plants</h4></div>
            <div className="ce">
