...
const Biennial= () => {
    ...
    const filteredDatal1 = PopularAPI.filter(product => product.id >= 96 && product.id <= 100);
    const filteredDatal2 =PopularAPI.filter(product => product.id >= 101 && product.id <= 105);
    return (
        <>
            <div className="ban" id="carou">
            <img src="/image/cercar2.jpg" className="Car" id="Image" alt="..." />
            </div>
            <div className="cerh"> <h4>Biennial Plants</h4></div>
            <div className="ce">
