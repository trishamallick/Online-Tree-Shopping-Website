...
const Creepers = () => {
  ...
  const filteredDatac1 = popularAPI.filter((product) => product.id >= 16 && product.id <= 20);
  const filteredDatac2 = popularAPI.filter((product) => product.id >= 21 && product.id <= 25);
