...
const Bamboop = () => {
  ...
  const filteredDatab1 = popularAPI.filter((product) => product.id >= 6 && product.id <= 10);
  const filteredDatab2 = popularAPI.filter((product) => product.id >= 11 && product.id <= 15);
