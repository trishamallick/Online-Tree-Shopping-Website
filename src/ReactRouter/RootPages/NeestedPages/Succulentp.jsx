...
const Succulentp = () => {
  ...
  const filteredDatas3 = popularAPI.filter((product) => product.id >= 46 && product.id <= 50);
  const filteredDatas4 = popularAPI.filter((product) => product.id >= 51 && product.id <= 55);
